                    ...
                    <form method="POST" action="{{ route('clientes.update', ['clientes' => $clientes]) }}" id="user-form" >
                        ...
                        <div class="flex flex-wrap -mx-3 mb-12 flex-inputs">
                            ...
                            <div class="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                             ...
                             <div class="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                                ...
                                <x-text-input id="nom_contacto" class="block mt-1 w-full" type="text" name="nom_contacto"  :value="$clientes->nom_contacto" oninput="validateNameInput(this)" />
                            </div>
                       ...
                       <div class="flex flex-wrap -mx-3 mb-12 flex-inputs">
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                           ...
                           <x-text-input id="observacion" class="block mt-1 w-full" type="text" name="observacion" :value="$clientes->observacion"/>
                       </div>
                   </div>
