...
@section('cuerpo')
    ...
    <section class="page-title img-encabezado"
        ...
        <div class="auto-container">
            <h2>Sistema APPSVEN - Tienda In House</h2>
            <ul class="bread-crumb clearfix">
                <li><a href="index.html">Inicio</a></li>
                <li> Sistema APPSVEN - Tienda In House</li>
            </ul>
        </div>
    </section>
    <!-- End Page Title -->
            ...
            <div class="row clearfix">
                ...
                <div class="content-side left-sidebar col-lg-8 col-md-12 col-sm-12">
                    <div class="service-detail">
                        <div class="inner-box">
                            <div class="image">
                                <img autoplay muted loop src="{{ asset('cliente/img/videos/APPSVEN_TiendaHouse.gif') }}"
                                    width="100%" />
                            </div>
                            <section id="descripcion">
                                ...
                                <p>Sistema APPSven TIENDA es un sistema especializado y de gestión para tiendas,
                                    minimarkets, distribuidoras y negocios a fines, que permite el control y monitoreo de
                                    todas las operaciones, esta versión esta desarrollado en una plataforma móvil CLIENTE -
                                    SERVIDOR con una distribución ANDROID el cual es instalado en un servidor o equipo
                                ...
                                <ul class="circulo">
                                    ...
                                    <li>Reporte de ventas por día, turno, terminal de venta y producto.</li>
                                    <li>reporte de ventas por cliente/grupo de clientes.</li>
                                    <li>Reporte de ventas por formas de pago.</li>
                                    <li>Reporte del registro de ventas detallado (SUNAT).</li>
                                    <li>Reporte del kardex en unidades o valorizado (SUNAT).</li>
                            ...
                            <section id="requisitos">
                                <h3><span class="px-2"><img src="{{ asset('cliente/img/icons/requisitos.png') }}"
                                    ...
                                    Previos</h3>
                                <ul class="circulo">
                                    <li>Servidor de datos o equipo de cómputo.</li>
                                    <li>Equipos de cómputo de puntos de venta (cpu, monitor, teclado, mouse, estabilizador,
                                        impresora térmica). </li>
                                    <li>Cableado red de punto de venta a servidor. </li>
                                    <li>Switch de datos para las redes. </li>
                                    <li>Equipo de cómputo oficina para controles administrativos. </li>
                                    <li>Puntos de red y energía en los terminales de venta.</li>
                            ...
                            <section id="implementacion">
                                <h3><span class="px-2"><img src="{{ asset('cliente/img/icons/implementacion.png') }}"
                                            alt="icono"></span>Implementación</h3>
                                <ul class="circulo">
                                    <li>• Día 1.- Instalación del Software APPSVEN TIENDA en equipos móviles o PC’S de punto
                                        de venta y oficina. </li>
                                    <li>• Día 1.- Instalación del Software facturación electrónica APPSVEN TIENDA y pruebas
                                        de generación y envió de comprobantes electrónicos.</li>
                                    <li>• Día 2.- Puesta en marcha del sistema APPSVEN TIENDA e inicio de las operaciones en
                                        los puntos de venta.</li>
                                    <li>• Día 3.- Capacitación, monitoreo y control del manejo del sistema a usuarios de
                                        oficina y operadores de puntos de venta.</li>
