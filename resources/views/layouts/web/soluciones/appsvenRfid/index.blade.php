    ...
    <section class="page-title img-encabezado"
        ...
        <div class="auto-container">
            ...
            <ul class="bread-crumb clearfix">
                ...
                <li> Sistema De Control De Flotas, Descuentos corporativos Y Fidelización RFID</li>
            </ul>
        </div>
    </section>
    <!-- End Page Title -->
                        ...
                        <div class="inner-box">
                            ...
                            <section id="descripcion">
                                ...
                                <p>Este es un conjunto de sistemas que permiten la gestión y control de los despachos de las
                                    flotas que abastecen así mismo el control de descuentos corporativos en mas de un local
                                    y la fidelización de clientes a través de stickers y pulseras RFID. Estos sistemas
                                    ayudan y complementan al crecimiento de la rentabilidad del negocio, destacamos el uso
                                    de las tecnologías RFID para controlar el plagio de códigos y la seguridad en los
                                    procesos.</p>
                            ...
                            <section id="implementacion">
                                ...
                                <!-- <p>Con más de una década de experiencia, nos hemos consolidado como una de las agencias pioneras en la región. Nuestras estructuras y procesos pequeños, flexibles, ágiles y basados ​​en el diseño nos permiten ser altamente receptivos e innovadores. Estamos formados por líderes, estrategas, gerentes, desarrolladores, animadores y diseñadores apasionados que trabajan juntos bajo un mismo paraguas. Somos una agencia creativa de servicio completo dirigida digitalmente. Combinamos estrategia, marketing, diseño.</p> -->
                                <ul class="circulo">
                                    <li>Día 1.- Instalación del Software en equipos móviles de punto de venta, oficina y
                                        dispensadores (control flotas). </li>
                                    <li>Día 1.- Instalación del Software y pruebas de generación y envió de comprobantes
                                        electrónicos o de control interno.</li>
                                    <li>Día 2.- Puesta en marcha del sistema e inicio de las operaciones en los puntos de
                                        venta.</li>
                                    <li>Día 3, 4.- Capacitación, monitoreo y control del manejo del sistema a usuarios de
