...
@section('cuerpo')
    ...
    <section class="page-title img-encabezado"
        ...
        <div class="auto-container">
            <h2>Sistema APPSVEN - Tienda Cloud</h2>
            <ul class="bread-crumb clearfix">
                <li><a href="index.html">Inicio</a></li>
                <li> Sistema APPSVEN - Tienda Cloud</li>
            </ul>
        </div>
    </section>
    <!-- End Page Title -->
            ...
            <div class="row clearfix">
                ...
                <div class="content-side left-sidebar col-lg-8 col-md-12 col-sm-12">
                    <div class="service-detail">
                        <div class="inner-box">
                            <div class="image">
                                <img autoplay muted loop src="{{ asset('cliente/img/videos/APPSVEN_TiendaCloud.gif') }}"
                                    width="100%" />
                            </div>
                            <section id="descripcion">
                                ...
                                <p>Sistema APPSven TIENDA es un sistema especializado y de gestión para tiendas,
                                    ...
                                    todas las operaciones, está desarrollado en una plataforma móvil EN LA NUBE con una
                                    distribución ANDROID el cual es instalado en un servidor virtual y requiere del servicio
                                    de internet estable en el negocio. Esta versión trabaja con redes inalámbricas (WIFI) y
                                    nos brinda varias bondades dentro las cuales podemos destacar:</p>
                                <ul class="circulo">
                            ...
                            <section id="requisitos">
                                ...
                                <ul class="circulo">
                                    ...
                                    <li>Equipos terminales móviles TABLETAS o PC’S en puntos de venta con impresora térmica
                                        bluetooth. </li>
                            ...
                            <section id="implementacion">
                                ...
                                <ul class="circulo">
                                    <li>Día 1.- Instalación del Software APPSVEN TIENDA en equipos móviles de punto de venta
                                        y oficina. </li>
                                    <li>Día 1.- Instalación del Software facturación electrónica APPSVEN TIENDA y pruebas de
                                    ...
                                    <li>Día 3, 4, y 5.- Capacitación, monitoreo y control del manejo del sistema a usuarios
                                        de oficina y operadores de punto de venta.</li>
                                </ul>
                            </section>
