    ...
    <section class="page-title img-encabezado"
        ...
        <div class="auto-container">
            ...
            <ul class="bread-crumb clearfix">
                ...
                <li>Sistema SFESVEN - Escritorio</li>
            </ul>
        </div>
    </section>
    <!-- End Page Title -->
                        ...
                        <div class="inner-box">
                            ...
                            <section id="descripcion">
                                ...
                                <p>Sistema Sven es un sistema especializado y de gestión para <b>Estaciones de Servicio</b>,
                                    que permite el control y monitoreo de todas las operaciones, esta versión esta
                                    desarrollado en una plataforma CLIENTE – SERVIDOR dentro del negocio permitiendo limitar
                                    las interrupciones de las operaciones de emisión de comprobantes y trabajos operativos
                                    por alguna alteración del servicio de internet. Esta versión nos brinda varias bondades
                                    dentro las cuales podemos destacar: </p>
                                <ul class="circulo">
                                    ...
                                    <li>Sistema de fidelización a través de tarjetas de banda magnética y código de barra.
                                    </li>
                            ...
                            <section id="requisitos">
                                ...
                                <ul class="circulo">
                                    ...
                                    <li>Módulo de punto de venta.</li>
                                    <li>Modulo de gabinete de piso para servidor y controlador.</li>
