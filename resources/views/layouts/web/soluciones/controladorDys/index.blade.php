...
@section('cuerpo')
    ...
    <section class="page-title img-encabezado"
        ...
        <div class="auto-container">
            <h2>Controlador de dispensadores / surtidores HORUSTECH</h2>
            <ul class="bread-crumb clearfix">
                <li><a href="index.html">Inicio</a></li>
                <li> Controlador de dispensadores / surtidores HORUSTECH</li>
            </ul>
        </div>
    </section>
    <!-- End Page Title -->
            ...
            <div class="row clearfix">
                ...
                <div class="content-side left-sidebar col-lg-8 col-md-12 col-sm-12">
                    <div class="service-detail">
                        <div class="inner-box">
                            <div class="image">
                                <img autoplay muted loop src="{{ asset('cliente/images/gif/CONTROLADOR.gif') }}"
                                    width="100%" />
                            </div>
                            <section id="descripcion">
                                <h3><span class="px-2"><img src="{{ asset('cliente/mages/icons/descripcion.png') }}"
                                            alt="Sistema para Estaciones de Servicios | Power Group System | icono"></span>Descripción
                                </h3>
                                <ul class="circulo">
                                    <li>Controla y gerencia todos los datos de dispensadores de gasolina, diesel, GLP, úrea
                                        líquida y gas natural </li>
                                    <li>Compatibilidad con dispensadores de las marcas: Gilbarco, Tokheim, Wayne, Petrotec,
                                        Wertco, Kraus, Petrolmeccanica, Yenen, 2A, Mepsan, Gaslin, Falcon, Durulsan,
                                        Bluesky, etc.</li>
                                    <li>Función nativa de identificación de clientes y operarios.</li>
                                    <li>Función de bloqueo y liberación por producto y preseteo de venta.</li>
                                    <li>Diseño moderno con soporte para pared, soporte para cables y soporte para rack
                                        (opcional).</li>
                                    <li>Almacena hasta 10 000 abastecimientos, 8 192 eventos y 65 536 tarjetas identfid.
                                    </li>
                                    <li>Capacidad para hasta 24 dispensadores</li>
                                </ul>
                            </section>
                            ...
                            <section id="requisitos">
                                ...
                                <ul class="circulo">
                                    ...
                                    <li>Tarjetas de interface electrónica en dispensadores surtidores.</li>
                                    <li>Tarjetas y sensores Identifid para dispensadores/surtidores.</li>
                                    <li>Ups y transformador de aislamiento para centro de datos.</li>
                                    <li>Módulo de gabinete de piso para controlador.</li>
                            ...
                            <section id="implementacion">
                                ...
                                <ul class="circulo">
                                    <li>Día 1.- Validación de comunicación de cableado en cada terminal de dispensadores y
                                        surtidores.</li>
                                    <li>Instalación de sensores en dispensadores/surtidores (si lo requiere).</li>
                                    <li>Día 1.- Validación de enlace dispensadores en modo electrónico. </li>
                                    <li>Día 2.- Instalación del Software Controlador HORUSTECH.</li>
                                    <li>Día 2.- Capacitación, monitoreo y control del manejo del sistema a usuarios de
                                        oficina y operadores de punto de venta.</li>
                                </ul>
                            </section>
