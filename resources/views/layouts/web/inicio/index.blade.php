...
@section('cuerpo')
        ...
        <div class="single-item-carousel owl-carousel owl-theme">
            ...
            <div class="slide">
                <div class="slider-two_image-layer"
                    style="background-image:url( {{ asset('cliente/images/background/grifo.jpg') }})"></div>
                <div class="slider-two_pattern-layer"
                    style="background-image:url( {{ asset('cliente/images/main-slider/pattern-1.png') }}); background-size: cover;">
                </div>
            ...
            <div class="slide">
                <div class="slider-two_image-layer"
                    style="background-image:url({{ asset('cliente/images/main-slider/bg-horustech.png') }})"></div>
                <div class="slider-two_pattern-layer"
                    style="background-image:url({{ asset('cliente/images/main-slider/pattern-1.pn') }}g) ;background-size: cover;">
                </div>
                <div class="auto-container">
            ...
            <div class="slide">
                <div class="slider-two_image-layer"
                    style="background-image:url({{ asset('cliente/images/main-slider/identfid.png') }})"></div>
                <div class="slider-two_pattern-layer"
                    style="background-image:url({{ asset('cliente/images/main-slider/pattern-1.png') }}) ;background-size: cover;">
                </div>
                <div class="auto-container">
            ...
            <div class="slide">
                <div class="slider-two_image-layer"
                    style="background-image:url({{ asset('cliente/images/main-slider/dispositivos.webp') }} )">
                </div>
                <div class="slider-two_pattern-layer"
                    style="background-image:url( {{ asset('cliente/images/main-slider/pattern-1.png') }}) ;background-size: cover;">
                </div>
            ...
            <div class="slide">
                <div class="slider-two_image-layer"
                    style="background-image:url({{ asset('cliente/images/main-slider/concept.webp') }})"></div>
                <div class="slider-two_pattern-layer"
                    style="background-image:url({{ asset('cliente/images/main-slider/pattern-1.png') }} ) ;background-size: cover;">
                </div>
                <div class="auto-container">
            ...
            <div class="slide">
                <div class="slider-two_image-layer"
                    style="background-image:url({{ asset('cliente/images/main-slider/RFID.webp') }})"></div>
                <div class="slider-two_pattern-layer"
                    style="background-image:url({{ asset('cliente/images/main-slider/pattern-1.png') }}) ;background-size: cover;">
                </div>
                <div class="auto-container">
            ...
            <div class="row clearfix d-flex justify-content-center">
                ...
                <div class="feature-block_one d-flex justify-content-center">
                    <div class="feature-block_one-inner">
                        ...
                        <span class="feature-block_one-icon">
                            <img src="{{ asset('cliente/iconos/icons8-desarrollo-de-software-100.png') }} "
                ...
                <div class="feature-block_one d-flex justify-content-center">
                    <div class="feature-block_one-inner">
                        ...
                        <span class="color-layer"></span>
                        <span class="feature-block_one-icon">
                            <img src="{{ asset('cliente/iconos/icons8-online-support-100.png') }}"
                ...
                <div class="feature-block_one d-flex justify-content-center">
                    <div class="feature-block_one-inner">
                        ...
                        <span class="color-layer"></span>
                        <span class="feature-block_one-icon">
                            <img src="{{ asset('cliente/iconos/icons8-cuenta-100.png') }}"
                ...
                <div class="feature-block_one d-flex justify-content-center">
                    <div class="feature-block_one-inner">
                        ...
                        <span class="color-layer"></span>
                        <span class="feature-block_one-icon">
                            <img src="{{ asset('cliente/iconos/icons8-computadora-100.png') }}"
                ...
                <div class="feature-block_one d-flex justify-content-center">
                    <div class="feature-block_one-inner">
                        ...
                        <span class="color-layer"></span>
                        <span class="feature-block_one-icon">
                            <img src="{{ asset('cliente/iconos/icons8-meeting-room-100.png') }}"
    ...
    <section class="clients-one">
        <div class="clients-one_pattern"
            style="background-image:url({{ asset('cliente/images/background/grifofondoh.jpg') }})"></div>
        <div class="auto-container">
                    ...
                    <ul class="sponsors-carousel-two owl-carousel owl-theme">
                        <li class="slide-item">
                            <figure class="client-one_image-box"><a><img
                                        src=" {{ asset('cliente/images/clients/5.png') }} "
                                        alt="Sistema para Estaciones de Servicios | Power Group System | cliente"></a>
                            </figure>
                        </li>
                        <li class="slide-item">
                            <figure class="client-one_image-box"><a><img
                                        src=" {{ asset('cliente/images/clients/6.png') }}"
                                        alt="Sistema para Estaciones de Servicios | Power Group System | cliente"></a>
                            </figure>
                        </li>
                        <li class="slide-item">
                            <figure class="client-one_image-box"><a><img
                                        src="{{ asset('cliente/images/clients/8.png') }}"
                                        alt="Sistema para Estaciones de Servicios | Power Group System | cliente"></a>
                            </figure>
                        </li>
                        <li class="slide-item">
                            <figure class="client-one_image-box"><a><img
                                        src="{{ asset('cliente/images/clients/9.1.png') }}"
                                        alt="Sistema para Estaciones de Servicios | Power Group System | cliente"></a>
                            </figure>
                        </li>
                        <li class="slide-item">
                            <figure class="client-one_image-box"><a><img
                                        src="{{ asset('cliente/images/clients/11.1.png') }}"
                                        alt="Sistema para Estaciones de Servicios | Power Group System | cliente"></a>
                            </figure>
                        </li>
                        <li class="slide-item">
                            <figure class="client-one_image-box"><a><img
                                        src="{{ asset('cliente/images/clients/12.1.png') }}"
                                        alt="Sistema para Estaciones de Servicios | Power Group System | cliente"></a>
                            </figure>
                        </li>
                        <li class="slide-item">
                            <figure class="client-one_image-box"><a><img
                                        src="{{ asset('cliente/images/clients/13.1.png') }}"
                                        alt="Sistema para Estaciones de Servicios | Power Group System | cliente"></a>
                            </figure>
                        </li>
                        <li class="slide-item">
                            <figure class="client-one_image-box"><a><img
                                        src="{{ asset('cliente/images/clients/14.1.png') }}"
                                        alt="Sistema para Estaciones de Servicios | Power Group System | cliente"></a>
                            </figure>
                        </li>
                        <li class="slide-item">
                            <figure class="client-one_image-box"><a><img
                                        src="{{ asset('cliente/images/clients/15.1.png') }}"
                                        alt="Sistema para Estaciones de Servicios | Power Group System | cliente"></a>
                            </figure>
                        </li>
                        <li class="slide-item">
                            <figure class="client-one_image-box"><a><img
                                        src="{{ asset('cliente/images/clients/17.1.png') }}"
                                        alt="Sistema para Estaciones de Servicios | Power Group System | cliente"></a>
                            </figure>
                        </li>
                        <li class="slide-item">
                            <figure class="client-one_image-box"><a><img
                                        src="{{ asset('cliente/images/clients/18.1.png') }}"
                                        alt="Sistema para Estaciones de Servicios | Power Group System | cliente"></a>
                            </figure>
                        </li>
                        <li class="slide-item">
                            <figure class="client-one_image-box"><a><img
                                        src="{{ asset('cliente/images/clients/19.png') }}"
                                        alt="Sistema para Estaciones de Servicios | Power Group System | cliente"></a>
                            </figure>
                        </li>
                    </ul>
    ...
    <section class="about-two">
        <div class="case-one_pattern-layer"
            style="background-image:url({{ asset('cliente/images/background/pattern-16.png') }} )"></div>
        <div class="about-two_pattern-two"
            style="background-image:url( {{ asset('cliente/images/background/pattern-13.png') }}); filter: hue-rotate(239deg);">
        </div>
        <div class="about-two_pattern-two pattern-two"
            style="background-image:url( {{ asset('cliente/images/background/pattern-13.png') }}); filter: hue-rotate(239deg); left: 100px; top: 665px;">
        </div>
            ...
            <div class="services-one_inner-coontainer">
                <div class="four-item-carousel owl-carousel owl-theme">
                    ...
                    <div class="service-block_three">
                        <div class="service-block_three-inner">
                            <span class="service-block_three-icon"><img
                                    src=" {{ asset('cliente/iconos/icons8-desarrollo-de-software-100.png') }} "
                                    width="50px"
                    ...
                    <div class="service-block_three">
                        <div class="service-block_three-inner">
                            <span class="service-block_three-icon"><img
                                    src=" {{ asset('cliente/iconos/icons8-online-support-100.png') }} " width="50px"
                    ...
                    <div class="service-block_three">
                        <div class="service-block_three-inner">
                            <span class="service-block_three-icon"><img
                                    src="{{ asset('cliente/iconos/icons8-computadora-100.png') }}" width="50px"
                    ...
                    <div class="service-block_three">
                        <div class="service-block_three-inner">
                            <span class="service-block_three-icon"><img
                                    src="{{ asset('cliente/iconos/icons8-meeting-room-100.png') }}" width="50px"
                ...
                <div id="slider-sistemas" class="three-item-carousel owl-carousel owl-theme owl-loaded owl-drag">
                        ...
                        <div class="card-container">
                            <div class="card">
                                <div class="front-content">
                                    <img src=" {{ asset('cliente/images/resource/licores.jpg') }} " alt=""
                                        style="height: 100%;">
                                </div>
                                <div class="content">
                    ...
                    <div>
                        <div class="card-container">
                            <div class="card">
                                <div class="front-content">
                                    <img src="{{ asset('cliente/images/resource/restaurante.avif') }}  " alt=""
                                        style="height: 100%;">
                                </div>
                                <div class="content">
                                    <p class="fw-bold parrafo-sistemas">
                    ...
                    <div>
                        <div class="card-container">
                            <div class="card">
                                <div class="front-content">
                                    <img src="{{ asset('cliente/images/resource/tienda.jpg') }}" alt=""
                                        style="height: 100%;">
                                </div>
                                <div class="content">
                                    <p class="fw-bold parrafo-sistemas">
                    ...
                    <div>
                        <div class="card-container">
                            <div class="card">
                                <div class="front-content">
                                    <img src="{{ asset('cliente/images/resource/ferreteria.jpg') }}" alt=""
                                        style="height: 100%;">
                                </div>
                                <div class="content">
                                    <p class="fw-bold parrafo-sistemas">
                    ...
                    <div>
                        <div class="card-container">
                            <div class="card">
                                <div class="front-content">
                                    <img src="{{ asset('cliente/images/resource/farmacia.jpg') }}" alt=""
                                        style="height: 100%;">
                                </div>
                                <div class="content">
                                    <p class="fw-bold parrafo-sistemas">
    ...
    <section class="choose-one">
        <div class="choose-one_pattern-layer"
            style="background-image:url({{ asset('cliente/images/background/pattern-19.png') }} ); filter: hue-rotate(239deg);">
        </div>
        <div class="auto-container">
        ...
        <div class="auto-container">
            <div class="counter-two_inner-container">
                <div class="counter-two_pattern-two"
                    style="background-image:url( {{ asset('cliente/images/background/pattern-21.png') }} ); filter: hue-rotate(288deg);">
                </div>
                <div class="counter-two_pattern-three"
                    style="background-image:url({{ asset('cliente/images/background/pattern-22.png') }}); filter: hue-rotate(288deg);">
                </div>
                <div class="counter-two_image-layer"
                    style="background-image:url({{ asset('cliente/images/background/grifos.jpg') }})"></div>
    ...
    <!-- Testimonial Section -->
    <section class="testimonial-section" style="background-image: url({{ asset('cliente/images/background/4.webp') }} )">
        <div class="pattern-layer-one"
            style="background-image: url({{ asset('cliente/images/background/pattern-25.png') }}  ); filter: hue-rotate(176deg);">
        </div>
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <div class="carousel-column col-lg-7 col-md-12 col-sm-12">
                    <div class="inner-column"
                        style="background-image: url({{ asset('cliente/images/background/pattern-26.png') }} )">
                        <div class="authors-outer">
                            <div class="author-one">
                                <img src=" {{ asset('cliente/images/resource/dispensador_resultado.webp') }}"
                                    alt="Sistema para Estaciones de Servicios | Power Group System | grifo" />
                            </div>
                            <div class="author-two">
                                <img src=" {{ asset('cliente/images/resource/tanquevacio_resultado.webp') }}"
                                    alt="Sistema para Estaciones de Servicios | Power Group System | grifo" />
                            </div>
                            <div class="author-three">
                                <img src=" {{ asset('cliente/images/resource/tanqueado_resultado.webp') }}"
                                    alt="Sistema para Estaciones de Servicios | Power Group System | grifo" />
                            </div>
                            <div class="author-four">
                                <img src=" {{ asset('cliente/images/resource/author-5.jpg') }}"
                                    alt="Sistema para Estaciones de Servicios | Power Group System | grifo" />
                            </div>
                        </div>
                        <div class="single-item-carousel owl-carousel owl-theme">
