        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex bg-white overflow-hidden shadow-s sm:rounded-lg" style="flex-direction: column">
                    ...
                    <form method="GET" action="{{ route('archivos.index') }}" class="flex items-center" style="gap: 1rem; padding: 1rem" >
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Buscar Documentos ..." class="w-full border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-md shadow-sm">
                    ...
                    <table style="flex: auto">
                        ...
                        <tbody class="text-gray-600">
                            ...
                            <tr>
                                ...
                                <td class="border px-4 py-2">
                                    <x-primary-button class="text-center py-2">
                                        <a href="{{ route('archivos.edit', ['documento' => $document]) }}">Editar</a>
                                    </x-primary-button>
                                    <x-danger-button class="text-center py-2">
                                        <a href="{{ route('archivos.delete', ['documento' => $document]) }}">Eliminar</a>
                                    </x-danger-button>
                                </td>
                            </tr>
