        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('cargos.save') }}" class="w-full max-w-lg"  enctype="multipart/form-data">
                        @csrf
                        <!-- Alertas de Cargos -->
                        <div class="flex flex-wrap -mx-3 mb-12">
                         ...
                         <div class="flex flex-wrap -mx-3 mb-12">
                            <div class="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                                <x-input-label :value="__('Ingresar Cargos: ')" class="font-semibold text-green-600" />
                            </div>
                        </div>
                        <!-- Nombre del Cargo -->
                        <div class="flex flex-wrap -mx-3 mb-12">
