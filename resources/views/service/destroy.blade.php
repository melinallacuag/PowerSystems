            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('service.destroy', ['service' => $service]) }}">
                        ...
                        @method('DELETE')
                        <!-- Mensaje de alaerta -->
                        <div class="text-sm font-medium text-gray-900 mb-4">¿Está seguro de que desea eliminar el servicio <strong class="text-red-600">{{ $service->name }}</strong>  ? </div>
                        <!-- Boton Eliminar Service -->
