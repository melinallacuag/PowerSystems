                    ...
                    <form method="POST" action="{{ route('videos.save') }}" class="w-full max-w-lg"  enctype="multipart/form-data">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-12">
                            ...
                            <div class="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                                ...
                                <x-text-input id="name" class="block mt-1 w-full" type="text" maxlength="50" name="name" :value="old('name')" required autocomplete="ruc" placeholder="Ingresar Nombre del Video" />
                        ...
                        <div class="flex flex-wrap -mx-3 mb-12">
                            ...
                            <div class="w-full md:w-1/2 px-3 mb-4 md:mb-0">
                                ...
                                <input id="url" class="block mt-1 w-full border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-md shadow-sm" type="file" name="url" accept="video/*" required />
